 ...
 * 不见满街漂亮妹，哪个归得程序员？ @BelongsProject: doctor-server @BelongsPackage: com.it.study.service @Author:
 * kanimito @CreateTime: 2024-08-21 10:12 @Description: TODO @Version: 1.0
 */
public interface DoctorService {
  ShiftDTO getDoctorByShiftTime(Long shiftTimeId);

  List<ShiftDTO> getDoctorByShiftTimeList(Integer doctorId, String date) throws ParseException;

  SysUsers getDoctor(Integer doctorId);
}
